...
FROM DUAL; -- 3 (INDEX X, 몇 먼째에 위치해 있는 가 O)
...
-- 년,월,일 같은  한글 또는 날짜와 관련 없는 문자는 팬턴 X
...
SELECT TO_DATE('2월 27일 화요일 12시 24분', 
...
-- 7행 나와야 될 것 같은 데 6행만 나옴!
--> 왜? COUNT() 내에 컬럼명을 작성하며 NULL은 제외
