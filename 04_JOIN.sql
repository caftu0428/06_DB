...
--> 컬럼이 16개가 아니라 15개 인 이유
 --> 컬럼 이름 같아서 두 테이블의 같은 컬럼이 포개지듯이 합쳐짐
...
-- 모든 행이 최종 결과(REULT SET)에 포함 되도록 하는 JOIN
-- == LEFT JOIN
...
-- EMPLOYEE, DERARTMENT, LOCATION 3개 조인
